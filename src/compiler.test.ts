...
describe("compileSVG", () => {
  it("compiles a single path element", () => {
    ...
    const path = assertDefined(result[0])
  ...
  it("compiles multiple path elements", () => {
    ...
    assert.equal(assertDefined(result[0]).commands.length, 3)
    assert.equal(assertDefined(result[1]).commands.length, 2)
    assert.equal(assertDefined(result[0]).style.fill, 0x00bcd4)
    assert.equal(assertDefined(result[1]).style.fill, null)
    assert.equal(assertDefined(result[1]).style.stroke, 0xffffff)
  })
  ...
  it("handles single-quoted attributes", () => {
    ...
    assert.equal(result.length, 1)
    assert.equal(assertDefined(result[0]).style.fill, 0xff0000)
  })
  ...
  it("handles multi-line path elements", () => {
    ...
    assert.equal(result.length, 1)
    assert.equal(assertDefined(result[0]).style.fill, 0xe91e63)
    assert.equal(assertDefined(result[0]).style.fillAlpha, 0.9)
    assert.equal(assertDefined(result[0]).style.stroke, 0xffffff)
  })
  ...
  it("resolves all style properties", () => {
    ...
    const style = assertDefined(result[0]).style
